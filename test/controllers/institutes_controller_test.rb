...
class InstitutesControllerTest < ActionController::TestCase
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post :create, institute: { description: @institute.description, name: @institute.name, picture: @institute.picture }
    end
  ...
  test "should update institute" do
    patch :update, id: @institute, institute: { description: @institute.description, name: @institute.name, picture: @institute.picture }
    assert_redirected_to institute_path(assigns(:institute))
  end
